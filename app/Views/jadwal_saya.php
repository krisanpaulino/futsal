        ...
        <div class="row gx-md-8 gx-xl-12 gy-12">
            <div class="col-lg-12">
                <div class="author-info d-md-flex align-items-center mb-3">
                    <div class="d-flex align-items-center">
                        <div>
                            <h3 class="mb-4">Riwayat Jadwal</h3>
                        </div>
                    </div>
                </div>
                <hr class="mt-7 mb-6">
                <?php if (!empty($riwayat)) : ?>
                    <table class="table mb-0 small table-light">
                        ...
                        <tbody>
                            <?php foreach ($riwayat as $row) : ?>
                                <tr>
                                    ...
                                    <td class="p-2"><?= $row->waktu_mulai ?></td>
                                    <td class="p-2"><?= $row->waktu_selesai ?></td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
                    </table>
                <?php else : ?>
                    <div class="text-center">
                        <p class="text-dark">Belum ada riwayat jadwal.</p>
                    </div>
                <?php endif ?>
            </div>
            <!-- /column -->
